...
exports.convertTonimn = __webpack_require__(441).convert2nimn;
exports.getTraversalObj = xmlToNodeobj.getTraversalObj;
exports.convertToJson = nodeToJson.convertToJson;
exports.convertToJsonString = __webpack_require__(252).convertToJsonString;
exports.validate = validator.validate;
exports.j2xParser = __webpack_require__(177);
...
const util = __webpack_require__(692);
const buildOptions = __webpack_require__(692).buildOptions;
const xmlNode = __webpack_require__(40);
const regx =
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.infoLog = exports.uploadArtifact = exports.GithubActionInputs = void 0;
const core = __importStar(__webpack_require__(217));
const ts_nested_error_1 = __webpack_require__(784);
class GithubActionInputError extends ts_nested_error_1.NestedError {
}
exports.GithubActionInputs = {
    get(useDummy = false, values) {
        return Object.assign(Object.assign({}, (useDummy ? this.dummy() : this.real())), values);
    },
    dummy() {
        return {
    ...
    real() {
        var _a, _b, _c, _d;
        const zenn = getParsedInput('zenn', '[]');
        const qiita = getParsedInput('qiita', '[]');
        const retentionDays = parseInt((_a = core.getInput('retentionDays')) !== null && _a !== void 0 ? _a : '1', 10);
        const artifactName = (_b = core.getInput('artifactName')) !== null && _b !== void 0 ? _b : 'articles';
        const outputJsonFileName = (_c = core.getInput('outputJsonFileName')) !== null && _c !== void 0 ? _c : 'articles.json';
        const qiitaToken = (_d = core.getInput('qiitaToken')) !== null && _d !== void 0 ? _d : '';
        return {
            zenn,
            qiita,
            retentionDays,
...
function getParsedInput(name, defaultValue) {
    var _a;
    try {
        return JSON.parse((_a = core.getInput('zenn')) !== null && _a !== void 0 ? _a : defaultValue);
    }
    catch (e) {
...
const luxon_1 = __webpack_require__(711);
const qiitaApiUrl = (userName) => `https://qiita.com/api/v2/users/${userName}/items`;
function fetchArticles(userName, accessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield node_fetch_1.default(qiitaApiUrl(userName), {
        ...
        return result.map((entity) => {
            return Object.assign(Object.assign({}, entity), { created_at: luxon_1.DateTime.fromISO(entity.created_at), updated_at: luxon_1.DateTime.fromISO(entity.updated_at) });
        });
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fetchArticles = void 0;
const fast_xml_parser_1 = __importDefault(__webpack_require__(479));
const luxon_1 = __webpack_require__(711);
const node_fetch_1 = __importDefault(__webpack_require__(287));
const demo = (/* unused pure expression or super */ null && (`
...
`));
const zennRssUrl = (id) => `https://zenn.dev/${id}/feed`;
function fetchArticles(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield node_fetch_1.default(zennRssUrl(userId));
        if (response.status !== 200) {
            return [];
        }
        ...
        return items.map((entity) => {
            return Object.assign(Object.assign({}, entity), { pubDate: luxon_1.DateTime.fromHTTP(entity.pubDate) });
        });
    });
}
exports.fetchArticles = fetchArticles;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const qiita = __importStar(__webpack_require__(368));
const zenn = __importStar(__webpack_require__(958));
const github = __importStar(__webpack_require__(525));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const actionsInput = github.GithubActionInputs.get();
        const result = [];
        for (const zennUser of actionsInput.zenn) {
            const articles = yield zenn.fetchArticles(zennUser.id);
        ...
        for (const qiitaUser of actionsInput.qiita) {
            const articles = yield qiita.fetchArticles(qiitaUser.id, actionsInput.accessToken);
            articles.forEach(article => {
                result.push({
